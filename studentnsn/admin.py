...
from .models import Address, PersonalInformation, Academics,PersonalDocuments, Examination,HSC,HSCMarks,SSLC,SSLCMarks,BriefDetails,Hosteller,BankDetails,RejoinStudent,DiplomaMark,DiplomaStudent,SemesterMarksheet,DiplomaMarksheet,Scholarship
