...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('scholarship_type', models.CharField(choices=[('Pudhumai Penn', 'Pudhumai Penn'), ('Naan Mudhalvan', 'Naan Mudhalvan'), ('7.5 Special Quota', '7.5 Special Quota'), ('Post Matric (BC/MBC)', 'Post Matric (BC/MBC)'), ('SC/ST', 'SC/ST'), ('First Graduate', 'First Graduate')], max_length=50)),
                ('academic_year_availed', models.IntegerField()),
                ('availed', models.BooleanField(default=False)),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('roll_number', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='studentnsn.personalinformation')),
            ],
            options={
